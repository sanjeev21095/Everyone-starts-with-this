# -*- coding: utf-8 -*-
"""
Created on Thu Mar  8 12:32:06 2018
...
X_train = X_train / 255
X_test = X_test / 255
#defining training and testing labels
...
def larger_model():
	model = Sequential()
	model.add(Convolution2D(96, (11, 11), padding='valid', input_shape=(1, 28, 28), activation='relu'))
